...
> 以项目是根据 https://github.com/tsy12321/MyOkHttp.git 项目修改而来。原项目主要用于Android处理。本项目主要用于Java后端。再次特意感谢 tsy12321
...
```java
String url = "http://192.168.2.135/okhttpx/post.php";
...
```java
String url = "http://192.168.2.135/okhttpx/post_json.php";
...
```java
String url = "http://192.168.2.135/okhttpx/get.php";
...
```java
String url = "http://192.168.2.135/okhttpx/patch.php/id/5/name/tsy";
...
```java
String url = "http://192.168.2.135/okhttpx/put.php/id/5/name/tsy/age/15";
...
```java
String url = "http://192.168.2.135/okhttpx/delete.php/id/5";
...
```java
String url = "http://192.168.2.135/okhttpx/upload.php";
...
```java
String url = "http://192.168.2.135/okhttpx/head.jpg";
...
```java
mOkHttpX.cancel(this);     //tag 即之前请求时传入的tag 建议直接将页面作为object传入
```
